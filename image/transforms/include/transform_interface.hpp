...
protected:
	...
	ITransform(TransformType _type = Transform_Unknown) :
		m_transformType(_type), m_nextTransform(nullptr) {}
...
public:
	...
	virtual ITransform& setNextTransform(ITransform::Ptr _next) {
		this->m_nextTransform = _next;
		return *this;
	}
