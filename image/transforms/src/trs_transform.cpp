...
TRSTransform::TRSTransform(void) : ITransform(TransformType::TRS) {
...
glm::mat4 TRSTransform::matrix() const { return this->cached_matrix; }

glm::vec3 TRSTransform::scaling() const { return this->m_scaling; }

glm::vec3 TRSTransform::rotation() const { return this->m_rotation; }

glm::vec3 TRSTransform::translation() const { return this->m_translation; }
