...
namespace Image {
	...
	template <>
	GenericImageReaderSubregionTemplated<std::uint8_t>::GenericImageReaderSubregionTemplated(svec3 _o, svec3 _s, Grid::Ptr _g) :
		GenericImageReaderSubregion(_o, _s, _g) {
	...
	template <>
	GenericImageReaderSubregionTemplated<std::uint16_t>::GenericImageReaderSubregionTemplated(svec3 _o, svec3 _s, Grid::Ptr _g) :
		GenericImageReaderSubregion(_o, _s, _g) {
	...
	template <>
	GenericImageReaderSubregionTemplated<std::uint32_t>::GenericImageReaderSubregionTemplated(svec3 _o, svec3 _s, Grid::Ptr _g) :
		GenericImageReaderSubregion(_o, _s, _g) {
	...
	template <>
	GenericImageReaderSubregionTemplated<std::uint64_t>::GenericImageReaderSubregionTemplated(svec3 _o, svec3 _s, Grid::Ptr _g) :
		GenericImageReaderSubregion(_o, _s, _g) {
	...
	template <>
	GenericImageReaderSubregionTemplated<std::int8_t>::GenericImageReaderSubregionTemplated(svec3 _o, svec3 _s, Grid::Ptr _g) :
		GenericImageReaderSubregion(_o, _s, _g) {
	...
	template <>
	GenericImageReaderSubregionTemplated<std::int16_t>::GenericImageReaderSubregionTemplated(svec3 _o, svec3 _s, Grid::Ptr _g) :
		GenericImageReaderSubregion(_o, _s, _g) {
	...
	template <>
	GenericImageReaderSubregionTemplated<std::int32_t>::GenericImageReaderSubregionTemplated(svec3 _o, svec3 _s, Grid::Ptr _g) :
		GenericImageReaderSubregion(_o, _s, _g) {
	...
	template <>
	GenericImageReaderSubregionTemplated<std::int64_t>::GenericImageReaderSubregionTemplated(svec3 _o, svec3 _s, Grid::Ptr _g) :
		GenericImageReaderSubregion(_o, _s, _g) {
	...
	template <>
	GenericImageReaderSubregionTemplated<float>::GenericImageReaderSubregionTemplated(svec3 _o, svec3 _s, Grid::Ptr _g) :
		GenericImageReaderSubregion(_o, _s, _g) {
	...
	template <>
	GenericImageReaderSubregionTemplated<double>::GenericImageReaderSubregionTemplated(svec3 _o, svec3 _s, Grid::Ptr _g) :
		GenericImageReaderSubregion(_o, _s, _g) {
	...
	std::size_t GenericImageReaderSubregionTemplated<element_t>::load_slice_from_parent_grid(std::size_t slice_idx) {
		...
		// Sanity check :
		if (slice_idx >= resolution.z) {
			throw std::runtime_error("Error : tried to load past-the end of the image.");
		}

		// if already cached previously :
		if (this->read_cache.hasData(slice_idx)) {
			return this->read_cache.findIndex(slice_idx);
		}
	...
	bool GenericImageReaderSubregionTemplated<element_t>::templated_read_region(svec3 origin, svec3 size, std::vector<out_t>& values) {
		...
		//
		if (origin.x >= resolution.x || origin.y >= resolution.y || origin.z >= resolution.z) {
			return true;
		}
