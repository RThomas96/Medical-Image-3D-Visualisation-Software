...
class texture_viewer : public QGLViewer {
		...
		/// @brief Qt widget to move the faces of the cube in real time
	...
	public slots:
		...
		/// @brief Toggles the need to be in regular space or transformed space.
		void toggle_distortion() { this->undistort = !this->undistort; this->update(); }
	private:
