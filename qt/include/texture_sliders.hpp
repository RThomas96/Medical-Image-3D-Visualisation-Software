#ifndef QT_INCLUDE_TEXTURE_SLIDERS_HPP_
#define QT_INCLUDE_TEXTURE_SLIDERS_HPP_
...
class texture_sliders : public QWidget {
		Q_OBJECT
	private:
		/**
	...
	public:
		 ...
		 */
		texture_sliders(texture_viewer* viewer);
	private:
		/**
...
#endif // QT_INCLUDE_TEXTURE_SLIDERS_HPP_
