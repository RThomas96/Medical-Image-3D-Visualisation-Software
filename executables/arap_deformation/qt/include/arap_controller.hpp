...
protected slots:
	...
	void saveCurve();
	/// @brief Save the image loaded in memory.
	void saveImageToBinaryFile();
...
protected:
	...
	QString output_image_file_name;	///< The file name of the output image
	QString output_image_file_path;	///< The file path to the output image
