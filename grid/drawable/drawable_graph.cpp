...
UITool::GL::Graph::Graph(GraphMesh * mesh) : graph(mesh)
{
...
void UITool::GL::Graph::incrementSize(const DrawingPrimitive& object) {
    switch(object) {
        case SPHERE:
...
void UITool::GL::Graph::decrementSize(const DrawingPrimitive& object) {
    switch(object) {
        case SPHERE:
            this->sphereRatio -= 0.1;
            break;
...
void UITool::GL::Graph::zoom(float sceneRadius) {
