...
void checkTetMeshBuildCube() {
    ...
    std::cout << "If working: " << coord1 << " == " << coord2 << std::endl;

    std::cout << "If working: " << glm::vec3(0.01, 0.01, 0.5) << " == " << tet1.baryToWorldCoord(coord1) << std::endl;
}

/* Unit test */
void checkTetMeshBaryCoord() {
