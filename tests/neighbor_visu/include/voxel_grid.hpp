...
class VoxelGrid {
	...
	public:
		...
		VoxelGrid& setGridSize(svec3 newDimensions);
	...
	protected:
		void reserveSpace(); // Allocate the needed space for filling the data progressively.
		void computeData(); // Compute te values to put in the grid
